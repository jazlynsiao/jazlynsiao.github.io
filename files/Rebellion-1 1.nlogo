...
to enforce
  if any? (agents-on neighborhood) with [ active? ] [
    ...
    ask suspect [
      set active? false
      set jail-term random satisfaction
    ]
  ]
end
...
to display-agent-2d  ; agent procedure
  ...
  ifelse active?
    ...
    [ ifelse jail-term > 0
        [ set color black + 3 ]
        [ set color scale-color red grievance 1.5 -0.5 ] ]
end
...
"" ""
PENS
"Scared" 1.0 0 -8053223 true "" "plot count agents with [not active? and jail-term = 0]"
"Support" 1.0 0 -16777216 true "" "plot count agents with [jail-term > 0]"
"Rebel" 1.0 0 -12087248 true "" "plot count agents with [active?]"
...
Polygon -10899396 true false 195 135 240 30 210 15 165 120
Circle -7500403 true true 110 5 80
Rectangle -7500403 true true 127 79 172 94
Polygon -10899396 true false 105 90 120 195 90 285 105 300 135 300 150 225 165 300 195 300 210 285 180 195 195 90
Polygon -10899396 true false 105 135 60 30 90 15 135 120
